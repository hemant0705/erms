...
if(isset($_POST['submit']))
  {
    ...
    $emppanno=$_POST['EmpPanNo'];
     $query=mysqli_query($con, "update employeedetail set EmpFname='$FName',  EmpLName='$LName', EmpCode='$empcode', EmpDept='$EmpDept', EmpDesignation='$EmpDesignation', EmpContactNo='$EmpContactNo', EmpGender='$gender',EmpJoingdate='$empjdate',EmpPanNo='$emppanno' where ID='$eid'");
    if ($query) {
               ...
               <div class="row">
                <div class="col-4 mb-3">First Name</div>
                   <div class="col-8 mb-3">   <input type="text" class="form-control form-control-user" id="FirstName" name="FirstName" aria-describedby="emailHelp" value="<?php  echo $row['EmpFname'];?>"></div>
                    ...
                    <div class="row">
                      <div class="col-4 mb-3">Employee Pan No.</div>
                    <div class="col-8 mb-3">
                      <input type="text" class="form-control form-control-user" id="EmpPanNo" name="EmpPanNo" aria-describedby="emailHelp" value="<?php  echo $row['EmpPanNo'];?>">
                    </div></div>
                    <div class="row">
